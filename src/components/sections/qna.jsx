		...
		<div className="section-row mt-17 flex flex-col">
			...
			<Question title="Is there a free trial of Syncspace AI? How much does it cost?">
				...
				<p>
					...
					that it will cost you ~$2-4 per month per user with heavy
					usage. Note: if you use AI in Automations, you can spend
					more money in your OpenAI account way faster. 😅
				</p>
			</Question>
			...
			<Question title="What happens if we invite/deactivate users when on a paid plan?">
				<p>
					When you invite a new user, we charge you proportionally to
					the time left in the billing cycle. For example, if you pay
					annually and there are six months left until the next
					payment, the prorated amount is $10*(6/12)*12=$60.
				</p>
				<br />
				<p>
			...
			<Question title="What payment methods do you accept?">
				...
				bank transfer, please contact us via Intercom — we will try to
				make it happen.
			</Question>
			<Question title="How do we pay for multiple workspaces?">
				If your organization owns several workspaces that share users,
				contact us via Intercom for a custom invoice. We don't want to
				charge you for the same users twice.
			</Question>
			<Question title="How is the payment being processed?">
				We use Braintree to process your payment. Braintree handles
				billions of dollars in transactions and is trusted by companies
				like Uber, Dropbox, and GitHub. We do not store or handle your
			...
			<Question title="Can we cancel our paid plan?">
				Sure, feel free to cancel your subscription at any time. All the
				benefits of the paid plan will remain till the end of your
				billing cycle. Once the billing cycle is over, we won't charge
				you again, and your workspace will switch into read-only mode.
			</Question>
		</div>
